...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        for x in range(0, WORLD_SIZE, SPRITE_SIZE):
            wall = arcade.Sprite("resources/images/tiles/bedrock.png", SPRITE_SCALING)
        ...
        for x in range(0, WORLD_SIZE, SPRITE_SIZE):
            ...
            wall = arcade.Sprite("resources/images/tiles/grass_block.png", SPRITE_SCALING)
            ...
            if x % r(100,200) == 0:
                pipe = arcade.Sprite("resources/images/tiles/pipe.png", SPRITE_SCALING-.5)
                pipe.bottom = abs(b)+SPRITE_SIZE
                pipe.left = x
                self.pipe_list.append(pipe)
            for y in range(1, int(wall.bottom), SPRITE_SIZE):
                wall2 = arcade.Sprite("resources/images/tiles/dirt.png", SPRITE_SCALING)
        ...
        for i in range(5):
            # Create a new Sprite
            entity = arcade.Sprite(f"resources/images/entities/{choice(['creeper','spider'])}.png", SPRITE_SCALING)
